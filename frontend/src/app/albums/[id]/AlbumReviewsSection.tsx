...
interface AlbumReviewsSectionProps {
  albumId: string;
}

export function AlbumReviewsSection({ albumId }: AlbumReviewsSectionProps) {
    ...
    <section className="mt-12">
      ...
      {loading ? (
        ...
        <div className="text-center py-12 bg-neutral-900/50 border border-neutral-800 rounded-lg">
          ...
          <p className="text-neutral-400 text-sm">Be the first to review this album!</p>
        </div>
      )}
    </section>
  );
